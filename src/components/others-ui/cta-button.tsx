...
export default function CtaButton({ label, href, className }: CtaButtonProps) {
  const content = (
    <button className={`bg-[#fff] hover:bg-black transition-colors duration-200 group flex items-center gap-2 px-6 py-3 sm:px-8 sm:py-4 rounded-full text-secondary hover:text-white text-sm sm:text-base lg:text-lg font-bangers w-fit ${className || ""}`}>
