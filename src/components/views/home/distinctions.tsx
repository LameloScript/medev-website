    ...
    <section className="relative bg-black text-white w-full overflow-hidden">
      ...
      <div className="container-fixed py-22 px-4 lg:px-20 relative z-10">
        <div className="flex flex-col items-start lg:items-center justify-center">
          <span className="text-xs md:text-sm items-start lg:text-center">[ NOS DISTINCTIONS ]</span>
          <h2 className="font-bangers text-3xl md:text-4xl lg:text-5xl mt-4 md:mt-6 items-start lg:text-center lg:leading-14 leading-tight">
            Nous sommes taillé pour vos besoins <span className="text-secondary">et vos défis.</span>
          </h2>
          <p className="items-start lg:text-center font-nunito text-sm md:text-base lg:text-lg leading-relaxed max-w-3xl mt-4 md:mt-6">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {awards.map((award, i) => (
            <div key={i} className="flex flex-col items-start gap-4">
              ...
              />
              <p className="font-nunito text-base lg:text-xl md:text-base leading-relaxed">
                {award.text}
              </p>
            </div>
          ))}
