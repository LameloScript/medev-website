      ...
      <div className="pt-24 pb-8 lg:pt-28 lg:pb-12">
        <div className="container-fixed px-4 lg:px-8 flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 text-base lg:text-lg font-nunito mt-4 max-w-3xl">
            Ce sont des projets privés propriétaires, gérés et pilotés par Medev Group. Découvrez les projets innovants que nous développons pour transformer l'Afrique grâce à la technologie. De l'AgriTech à la FinTech, nos ventures créent un impact positif sur le continent.
          </p>
        </div>
      </div>
