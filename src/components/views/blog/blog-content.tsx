        ...
        <div className="container-fixed px-4 lg:px-8">
          ...
          {filteredArticles.length > 6 && (
            <div className="flex items-center justify-center mt-16">
              <button className="bg-secondary hover:bg-black transition-colors duration-200 flex items-center gap-2 px-6 py-3 rounded-full text-white text-base font-bangers w-fit">
        ...
        <div className="container-fixed px-4 lg:px-8">
          <div className="bg-gradient-to-br from-secondary/10 to-gray-100 rounded-2xl p-8 lg:p-16 text-center border border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <button className="bg-secondary hover:bg-black transition-colors duration-200 px-6 py-3 rounded-full text-white font-bangers whitespace-nowrap">
                S'inscrire
              </button>
            </div>
          </div>
